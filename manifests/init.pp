...
class report_slack (
  ...
  Boolean $slack_only_link_report                                  = false,
  Optional[String] $slack_puppetboard_url                          = undef,
  Optional[Array[String]] $slack_attach_log_tags                   = undef,
  Optional[Array[String]] $slack_environment_include_patterns      = undef,
  Optional[Array[String]] $slack_environment_mute_patterns         = undef,
  ...
  file { "${settings::confdir}/report_slack.yaml":
    ...
    content => epp("${module_name}/report_slack.yaml.epp",
      { 'slack_default_webhook'              => $slack_default_webhook,
        ...
        'slack_puppetboard_url'              => $slack_puppetboard_url,
        'slack_only_link_report'             => $slack_only_link_report,
